...
* Execute the below command to view the results of the default test suite using Jasmine and Karma.
...
* There will be some errors on the AppComponent's spec file since we changed the HTML. We are not so interested in these more complete test examples just yet but we might as well get them working.
...
* Add wallaby by using the 'ng add' command. This will add wallaby to your Angular CLI application.
