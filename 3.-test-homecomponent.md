---
description: >-
  In this section we will introduce unit testing in Angular and make a simple
  test.
---
...
* The run 'npm i ' to install the jest npm packages needed.

```text
npm i
```

* We will need to update the "tsconfig.json" files "compilerOptions/module" option to be "commonjs".
...
5. Start wallaby by pressing "ctrl + shft + p" and searching for wallaby start.
